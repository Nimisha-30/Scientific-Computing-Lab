# goal is to assign routes for the vehicles to pick up and deliver all the items, while minimizing the length of the longest route
...
def createDataModel():
    data = {}
    # list of pairs of pickup and delivery locations
    data["distanceMatrix"] = [
    ...
    for request in data['pickups_deliveries']:
        ...
        routing.solver().Add(
            routing.VehicleVar(pickup_index) == routing.VehicleVar(
                delivery_index))
        # each item must be picked up before it is delivered. cumulative distance at an item's pickup location is at most its cumulative distance at the delivery location
        routing.solver().Add(
